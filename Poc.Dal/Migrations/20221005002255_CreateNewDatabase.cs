        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Skillsets = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EventId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EventCode = table.Column<string>(type: "nvarchar(6)", maxLength: 6, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Cuenca", "", "Guayaquil", "Ecuador", "roberto@mail.com", "Roberto el malo", "0962089555", "C# as fuck", "09101" },
                    { 2, "Cuenca", "", "Guayaquil", "Ecuador", "roberto@mail.com", "Roberto el bueno", "0962089555", "C# as fuck", "09101" },
                    { 3, "Cuenca", "", "Guayaquil", "Ecuador", "roberto@mail.com", "Roberto el feo", "0962089555", "C# as fuck", "09101" }
                });
